...
#
# Aggregate batting/pitching features for test/training years (most likely start in 2012)
# 
# Try different Time Series models to see what fits best (with preprocessing analysis)
# 

# 4. Conferences
#
# See the evolution of relationship between all divisions
#
# These are just starting assumptions and the data should update them.

# 5. What we want from the model
# - how strong the batting effect is each season
# - how strong the pitching effect is each season
# - how the relationship changes overtime and the future
#
...
#
# e. Fit Time Series model
#
# f. Understand relation between pitching and batting. Predict furture relationships